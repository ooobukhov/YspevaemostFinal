...
{
    public partial class ClassesAD : Form
    {
        public ClassesAD()
        {
            InitializeComponent();
        ...
        {
            classesBindingSource1.Filter = "ClassName='" + filterCB.Text + "'";
        }

        private void pokazatVseBT_Click(object sender, EventArgs e)
        {
            classesBindingSource1.Filter = "";
        }
...
MessageBoxIcon.Question);
        ...
        private void ClassesAD_Load(object sender, EventArgs e)
        {
            // TODO: данная строка кода позволяет загрузить данные в таблицу "diplom_YspevaemostDataSet1.Classes". При необходимости она может быть перемещена или удалена.
            this.classesTableAdapter1.Fill(this.diplom_YspevaemostDataSet1.Classes);

        }

        private void printDocument1_PrintPage(object sender, System.Drawing.Printing.PrintPageEventArgs e)
        {
            Bitmap bmp = new Bitmap(classesDataGridView.Size.Width + 10, classesDataGridView.Size.Height + 10);
            classesDataGridView.DrawToBitmap(bmp, classesDataGridView.Bounds);
...
MessageBoxIcon.Question);
            if (result == DialogResult.Yes)
            {
                classesBindingSource1.RemoveCurrent();
