...
{
    public partial class StudentsAD : Form
    {
        public StudentsAD()
        {
            InitializeComponent();
        ...
        private void Sortirovka_Click(object sender, EventArgs e)
        {
            ...
            switch (PoleSortirovki.SelectedIndex)
            {
                ...
                case 4:
                    ...
                    break;
                    case 7: COL = dataGridViewTextBoxColumn8;
                    break;
            }
...
MessageBoxIcon.Question);
        ...
        private void StudentsAD_Load(object sender, EventArgs e)
        {
        ...
        {
            Bitmap bmp = new Bitmap(studentsDataGridView.Size.Width + 10, studentsDataGridView.Size.Height + 10);
            studentsDataGridView.DrawToBitmap(bmp, studentsDataGridView.Bounds);
...
MessageBoxIcon.Question);
            if (result == DialogResult.Yes)
            {
                studentsBindingSource1.RemoveCurrent();
