...
{
    public partial class GradesAD : Form
    {
        public GradesAD()
        {
            InitializeComponent();
...
MessageBoxIcon.Question);
        ...
        private void GradesAD_Load(object sender, EventArgs e)
        {
        ...
        {
            Bitmap bmp = new Bitmap(gradesDataGridView.Size.Width + 10, gradesDataGridView.Size.Height + 10);
            gradesDataGridView.DrawToBitmap(bmp, gradesDataGridView.Bounds);
...
MessageBoxIcon.Question);
        ...
        {
            DinamicYspevaemosti frm = new DinamicYspevaemosti();
            frm.Show();
            this.Hide();
        }
