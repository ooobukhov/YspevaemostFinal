...
{
    public partial class TeachersST : Form
    {
        public TeachersST()
        {
            InitializeComponent();
        ...
        private void TeachersST_Load(object sender, EventArgs e)
        {
            // TODO: данная строка кода позволяет загрузить данные в таблицу "diplom_YspevaemostDataSet.Teachers". При необходимости она может быть перемещена или удалена.
            this.teachersTableAdapter.Fill(this.diplom_YspevaemostDataSet.Teachers);

        }

        private void filterBT_Click(object sender, EventArgs e)
        {
            teachersBindingSource.Filter = "Specialization='" + filterCB.Text + "'";
        }

        private void pokazatVseBT_Click(object sender, EventArgs e)
        {
            teachersBindingSource.Filter = "";
        }
